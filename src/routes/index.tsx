	...
	return (
		<main class="motion-duration-3000 motion-opacity-in mx-auto flex h-screen w-1/2 flex-col items-center justify-center gap-3 text-center">
			<span class="relative inline-flex items-center">
				...
				<AppThemeSwitcher class="tooltip tooltip-right tooltip-info btn btn-ghost btn-circle motion-duration-500 motion-ease-in-out motion-delay-600 -top-1 -right-5.5 absolute size-5" />
			</span>
			<Tabs>
				<Tabs.Tab id="about" />
